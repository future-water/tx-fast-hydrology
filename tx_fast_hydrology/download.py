...
def download_forcings(date_str, forecast_start_hour, comids, sleeptime=0.1):
    # Download NetCDF forcings
    datasets = {}
    for lookahead_hour in range(1, 19):
        url = f'{baseurl}/nwm.{date}/short_range/nwm.t{forecast_start_hour:02}z.short_range.channel_rt.f{lookahead_hour:03}.conus.nc'
